...
export default class LiveStockStepTwoScreen extends Component {
    ...
    loadBreedFromStorage = async () => {
        try {
            ...
            // this.setState({stepName : breedData[1].nameEnglish})
            ...
            if (this.state.textLanguageChange === '0') {
                ...
                this.setState({ stepName: breedData[1].nameHindi })
                this.setState({ stepDescription: breedData[1].hindi })
            } else if (this.state.textLanguageChange === '2') {
                this.setState({ stepName: breedData[1].nameHo })
            ...
            if (this.state.livestockName === 'Pig' || this.state.livestockName === 'Goat' || this.state.livestockName === 'Backyard Poultry') {
