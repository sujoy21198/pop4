...
export default class StepFiveScreen extends Component {
    ...
    getOfflineData = async () => {
        try {
            ...
            this.setState({ englishDescription: cropSpecificSteps[4].english })
            this.setState({ hindiDescription: cropSpecificSteps[4].hindi })
            this.setState({ odiaDescription: cropSpecificSteps[4].odia })
            this.setState({ hoDescription: cropSpecificSteps[4].ho })
            this.setState({ santhaliDescription: cropSpecificSteps[4].santhali })
            this.setState({ englishTitleDescription: cropSpecificSteps[4].nameEnglish })
            this.setState({ hindiTitleDescription: cropSpecificSteps[4].nameHindi })
            this.setState({ odiaTitleDescription: cropSpecificSteps[4].nameOdia })
            this.setState({ hoTitleDescription: cropSpecificSteps[4].nameHo })
            this.setState({ santhaliTitleDescription: cropSpecificSteps[4].nameSanthali })
            this.setState({ stepImage: cropSpecificSteps[4].imageFile })
        } catch (error) {
            console.log(error)
        }
    }
    ...
    setStepDataIntoPatch = async () => {
        ...
        if (
            (
                ...
                files.includes("video_" + this.state.cropSpecificSteps[4].videoFile)
