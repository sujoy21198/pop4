...
export default class StepSevenScreen extends Component {
    ...
    getOfflineData = async () => {
        try {
            ...
            this.setState({ englishDescription: cropSpecificSteps[6].english })
            this.setState({ hindiDescription: cropSpecificSteps[6].hindi })
            this.setState({ odiaDescription: cropSpecificSteps[6].odia })
            this.setState({ hoDescription: cropSpecificSteps[6].ho })
            this.setState({ santhaliDescription: cropSpecificSteps[6].santhali })
            this.setState({ englishTitleDescription: cropSpecificSteps[6].nameEnglish })
            this.setState({ hindiTitleDescription: cropSpecificSteps[6].nameHindi })
            this.setState({ odiaTitleDescription: cropSpecificSteps[6].nameOdia })
            this.setState({ hoTitleDescription: cropSpecificSteps[6].nameHo })
            this.setState({ santhaliTitleDescription: cropSpecificSteps[6].nameSanthali })
            this.setState({ stepImage: cropSpecificSteps[6].imageFile })
        } catch (error) {
            console.log(error)
        }
    }
    ...
    setStepDataIntoPatch = async () => {
        ...
        if (
            (
                ...
                files.includes("video_" + this.state.cropSpecificSteps[6].videoFile)
