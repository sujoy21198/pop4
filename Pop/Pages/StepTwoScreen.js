...
export default class StepTwoScreen extends Component {
    ...
    getOfflineData = async () => {
        try {
            ...
            this.setState({ englishDescription: cropSpecificSteps[1].english })
            this.setState({ hindiDescription: cropSpecificSteps[1].hindi })
            this.setState({ odiaDescription: cropSpecificSteps[1].odia })
            this.setState({ hoDescription: cropSpecificSteps[1].ho })
            this.setState({ santhaliDescription: cropSpecificSteps[1].santhali })
            this.setState({ englishTitleDescription: cropSpecificSteps[1].nameEnglish })
            this.setState({ hindiTitleDescription: cropSpecificSteps[1].nameHindi })
            this.setState({ odiaTitleDescription: cropSpecificSteps[1].nameOdia })
            this.setState({ hoTitleDescription: cropSpecificSteps[1].nameHo })
            this.setState({ santhaliTitleDescription: cropSpecificSteps[1].nameSanthali })
            this.setState({ stepImage: cropSpecificSteps[1].imageFile })
        } catch (error) {
            console.log(error)
        }
    }
    ...
    setStepDataIntoPatch = async () => {
        ...
        if (
            (
                ...
                files.includes("video_" + this.state.cropSpecificSteps[1].videoFile)
                ...
                <ScrollView nestedScrollEnabled={true}>
...

                    {
                        ...
                        [
                            ...
                            <VideoComponent
                                asyncVideoFileName={this.state.cropSpecificSteps[1].videoFile}
